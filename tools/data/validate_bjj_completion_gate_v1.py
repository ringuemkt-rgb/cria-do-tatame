...
def build_report():
    ...
    p_count, positions = count_collection(graph, "positions", "posicoes")
...
def main():
    ...
    parser.add_argument("--full", action="store_true", help="fail unless the full BJJ source graph meets all machine-checkable completion conditions")
