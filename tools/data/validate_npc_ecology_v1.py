...
def main():
    ...
    for key in ["offline_core_required", "intention_requires_rules_validation", "same_seed_and_actions_require_same_state", "unknown_node_fails_closed", "npc_cannot_use_unknown_information"]:
    ...
    required_methods = [
        "func validate_profiles", "func new_state", "func step", "func resolve_schedule",
        "func can_access_fact", "func remember", "func set_event_override",
        "func _tier_for_node", "func _select_goal", "func _deterministic_jitter"
    ]
