...
var transicoes_validas := {
	...
	CombatState.PLAYER_SUBMISSION_ATTACK: [CombatState.RESET, CombatState.PLAYER_TOP_MOUNT, CombatState.PLAYER_TOP_SIDE, CombatState.PLAYER_BOTTOM_GUARD, CombatState.PLAYER_BACK_ATTACK],
	CombatState.PLAYER_SUBMISSION_DEFENSE: [CombatState.RESET, CombatState.PLAYER_TOP_GUARD, CombatState.PLAYER_BOTTOM_GUARD, CombatState.PLAYER_BOTTOM_SIDE, CombatState.PLAYER_BOTTOM_MOUNT, CombatState.PLAYER_BACK_DEFENSE],
