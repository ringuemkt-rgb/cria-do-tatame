...
func _ready() -> void:
	$MenuButtons/NewGame.text = "NOVO JOGO"
	$MenuButtons/Continue.text = "CONTINUAR"
	$MenuButtons/Options.text = "OPCOES"
	$MenuButtons/Continue.disabled = not SaveManager.has_save(1)
...
func _on_options_pressed() -> void:
	print("Opcoes ainda nao implementadas no Vertical Slice 0.1")
